...
def read_temp_state():
    ...
    if os.path.exists(temp_state_path):
        ...
        if temp_state_json:
            ...
            CC_DELETE_HIDDEN_FACES = get_attr(temp_state_json, "cc_delete_hidden_faces", True)
            CC_BAKE_TEXTURES = get_attr(temp_state_json, "cc_bake_textures", True)
            ...
            EXPORT_REMOVE_HIDDEN = get_attr(temp_state_json, "export_remove_hidden", True)
