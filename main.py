...
from utp import vars, prefs, error, options, utils, cc, qt, tests, importer, exporter, link
...
def menu_reload():
    ...
    modules = [ vars, prefs, error, options, utils, cc, qt, tests, importer, exporter, link ]
